<script>
  ...
  async function addData() {
    ...
    switch (page) {
      ...
      case "Slider":
        dataToSend = {
          imageUrl: document.getElementById("sliderItems_imageUrl").value,
          title: document.getElementById("sliderItems_title").value,
          description: document.getElementById("sliderItems_description").value,
          interval: document.getElementById("sliderItems_interval").value,
        };
        break;
      case "News":
        dataToSend = {
          ...
          buttonText: document.getElementById("news_buttonText").value,
        };
        break;
      case "Cards":
        dataToSend = {
          title: document.getElementById("contentCards_title").value,
          subtitle: document.getElementById("contentCards_subtitle").value,
          content: document.getElementById("contentCards_content").value,
          imageURL: document.getElementById("contentCards_imageURL").value,
...
<nav id="editNav">
  ...
  <div class="flexCenter" on:click={() => SetPage("Slider")} id="selectSlider">
    Slider
  </div>
  ...
  <div class="flexCenter" on:click={() => SetPage("Footer")} id="selectFooter">
    Footer
  </div>
      ...
      <div id="userEditForms" class="editForms">
        {#if addItem}
          <div class="flexCenter flexDirCol editPageForm">
            ...
            <button class="editPageSaveButton" on:click={() => addData()}
              >Add</button
            >
          </div>
        {:else}
          {#each editPageData.users as user, i}
            <div class="flexCenter flexDirCol editPageForm">
              ...
              <button
                ...
                on:click={() => deleteData(data.users[i].username)}
                >Delete</button
              >
            </div>
          {/each}
        ...
        {:else}
          {#each editPageData.headerItems as headerItem, i}
            <div class="flexCenter flexDirCol editPageForm">
              ...
              <button
                class="editPageDeleteButton"
                on:click={() => deleteData(data.headerItems[i].item)}
                >Delete</button
              >
            </div>
          {/each}
        ...
        {:else}
          {#each editPageData.sliderItems as sliderItem, i}
            <div class="flexCenter flexDirCol editPageForm">
              ...
              <div class="flexSpaceBetween">
                Image URL:
                <input type="text" bind:value={sliderItem.imageUrl} />
              </div>
              <div class="flexSpaceBetween">
                Description:
              ...
              <button
                class="editPageDeleteButton"
                on:click={() => deleteData(data.sliderItems[i].title)}
                >Delete</button
              >
            </div>
          {/each}
        ...
        {:else}
          {#each editPageData.news as newsItem, i}
            <div class="flexCenter flexDirCol editPageForm">
              ...
              <div class="flexSpaceBetween">
                Button text:
                <input type="text" bind:value={newsItem.buttonText} />
              </div>
              <button
                class="editPageSaveButton"
                on:click={() => saveData(i, data)}>Save</button
              ...
              <button
                class="editPageDeleteButton"
                on:click={() => deleteData(data.news[i].title)}>Delete</button
              >
            </div>
          {/each}
        {/if}
      ...
      <div id="cardsEditForms" class="editForms">
        {#if addItem}
          <div class="flexCenter flexDirCol editPageForm">
            ...
            <div class="flexSpaceBetween">
              Is On Left Side:
              <input type="checkbox" id="contentCards_isImageOnLeftSide" />
            </div>
        ...
        {:else}
          {#each editPageData.contentCards as contentCard, i}
            <div class="flexCenter flexDirCol editPageForm">
              ...
              <div class="flexSpaceBetween">
                Subtitle:
                <input type="text" bind:value={contentCard.subtitle} />
              </div>
              <div class="flexSpaceBetween">
                Image Url:
                <input type="text" bind:value={contentCard.imageURL} />
              </div>
              <div class="flexSpaceBetween">
                Content:
              ...
              <button
                class="editPageDeleteButton"
                on:click={() => deleteData(data.contentCards[i].title)}
                >Delete</button
              >
            </div>
          {/each}
        ...
        {#if addItem}
          ...
          {#each editPageData.footerItems as footerItem, i}
            <div class="flexCenter flexDirCol editPageForm">
              ...
              <button
                class="editPageDeleteButton"
                on:click={() => deleteData(data.footerItems[i].item)}
                >Delete</button
              >
            </div>
          {/each}
