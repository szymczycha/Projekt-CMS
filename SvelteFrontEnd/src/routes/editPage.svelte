...
<nav id="editNav">
    ...
    <div class="flexCenter" on:click={() => SetPage("base")} id="selectFooter">RAW</div>
</nav>
    ...
    <main class="flexCenter" id="editMain">
            ...
            <div id="userEditForms" class="editForms">
                {#each editPageData.users as user, i}
                    <div class="flexCenter flexDirCol editPageForm">
                        ...
                        <button class="editPageSaveButton" on:click={()=>{}}>Save</button>
                    </div>
                {/each}
            </div>
        {:else if page == "Nav"}
            ...
            <div id="sliderEditForms" class="editForms">
                {#each editPageData.sliderItems as sliderItem, i}
                    <div class="flexCenter flexDirCol editPageForm">
                        ...
                        <div class="flexSpaceBetween">
                            Interval:
                            <input type="number" min="0" max="100000" bind:value={sliderItem.interval}/>
                        </div>
                        <button class="editPageSaveButton" on:click={()=>{}}>Save</button>
                    </div>
                {/each}
        ...
        {:else if page == "News"}
            ...
            <div id="newsEditForms" class="editForms">
                {#each editPageData.news as newsItem}
                <div class="flexCenter flexDirCol editPageForm">
                    <div class="flexSpaceBetween">
                        Title:  
        ...
        <div id="cardsEditForms" class="editForms">
            {#each editPageData.contentCards as contentCard}
            <div class="flexCenter flexDirCol editPageForm">
                <div class="flexSpaceBetween">
                    Title:  
                ...
                <div class="flexSpaceBetween">
                    Is On Left Side:  
                    <input type="checkbox" bind:checked={contentCard.content}/>
                </div>
